...
export const userRoutes = new Elysia({ prefix: "/api/v1/users" })
  ...
  .get("/",
    async (context) => await userController.getAllUsers(context),
    {
      query: t.Object({
  ...
  .get("/:id",
    async (context) => await userController.getUserById(context),
    {
      params: t.Object({
  ...
  .delete("/:id",
    async (context) => await userController.deleteUser(context),
    {
      params: t.Object({
        id: t.String({ description: "User ID" })
      }),
