...
```json
{
  "category_name": "ท่องเที่ยวและพักผ่อน"
}
```
...
| พารามิเตอร์ | ประเภท | จำเป็น | คำอธิบาย |
|-----------|------|----------|-------------|
| `category_name` | string | ✅ | ชื่อหมวดหมู่ (ต้องไม่ซ้ำ) |
...
#### ❌ การตอบกลับเมื่อเกิดข้อผิดพลาด (409 Conflict)
```json
{
  "success": false,
  "error": "ชื่อหมวดหมู่มีอยู่แล้ว"
}
```
...
```json
{
  "category_name": "การท่องเที่ยวและผจญภัย"
}
```
...
| พารามิเตอร์ | ประเภท | จำเป็น | คำอธิบาย |
|-----------|------|----------|-------------|
| `category_name` | string | ✅ | ชื่อหมวดหมู่ใหม่ |
...
#### ❌ การตอบกลับเมื่อเกิดข้อผิดพลาด (409 Conflict - มีรายการเงิน)
```json
{
  "success": false,
  "error": "ไม่สามารถลบหมวดหมู่ที่มีรายการเงินอยู่"
}
```

#### ❌ การตอบกลับเมื่อเกิดข้อผิดพลาด (409 Conflict - มีงบประมาณ)
```json
{
  "success": false,
  "error": "ไม่สามารถลบหมวดหมู่ที่มีงบประมาณอยู่"
}
```
